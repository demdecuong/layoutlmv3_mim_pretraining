...
# from mytransformers.src.transformers.models.layoutlmv3.modeling_layoutlmv3 import LayoutLMv3MaskedImageModeling
from modeling_pretrain_layout import LayoutLMv3MaskedImageModeling
...
def get_model(args):
    print(f"Creating model: LAYOUTLMV3")

    # if args.model == 'layoutlm':
    model = LayoutLMv3MaskedImageModeling(
        vocab_size=8192
    )
    # else:
    #     model = create_model(
