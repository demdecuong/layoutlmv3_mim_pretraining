...
class DataAugmentationForBEiT(object):
    ...
    def __call__(self, image):
        ...
        # print(for_patches.size,for_visual_tokens.size)
        # print(self.patch_transform(for_patches).shape,self.visual_token_transform(for_visual_tokens).shape)
        # print(self.masked_position_generator().shape)
        # print(self.masked_position_generator())
        # exit()
        # print('dataloader here 1',image.size)
        # encoding = self.processor(image, return_tensors="pt")
        # print('dataloader here 2',encoding.keys())
        return \
        ...
        #     self.patch_transform(for_patches), self.visual_token_transform(for_visual_tokens), \
        #     self.masked_position_generator(), \
        #     encoding['input_ids '], encoding['bbox'], encoding['pixel_values'], encoding['attention_mask']
